...
export class UserSettings {
    ...
    /**
     * Get or set the screensaver timeout.
     * @param {number|undefined} val - The timeout in seconds before the screensaver activates
     * @return {number} - The screensaver timeout
     */
    screensaverTimeout(val) {
        if (val != undefined) {
            return this.set('screensaverTimeout', val.toString(), false);
        }

        return parseInt(this.get('screensaverTimeout', false), 10) || 15;
    }
...
export const screensaverTimeout = currentSettings.screensaverTimeout.bind(currentSettings);
